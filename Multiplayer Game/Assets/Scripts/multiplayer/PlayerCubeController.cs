...
{
    private SerializedProperty m_rb;
    private SerializedProperty m_Speed;
    private SerializedProperty m_ApplyVerticalInputToZAxis;

    public override void OnEnable()
    {
        m_rb = serializedObject.FindProperty(nameof(PlayerCubeController.rb));
    ...
    private void DisplayPlayerCubeControllerProperties()
    {
        ...
        EditorGUILayout.PropertyField(m_rb);
    }
...
public class PlayerCubeController : NetworkTransform
{
    ...
    private void Update()
    {
        ...
        {
            rb.AddForce(m_Motion * Speed, ForceMode.Force);
